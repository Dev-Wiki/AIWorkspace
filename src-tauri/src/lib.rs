...
fn all_targets() -> Vec<AgentTarget> {
    ...
    vec![
        ...
        AgentTarget {
            id: "antigravity-ide-skills".into(),
            name: "Antigravity IDE Skills".into(),
            content_type: "skills".into(),
            path: format!("{}/.gemini/antigravity-ide/skills", home),
            backend: "local".into(),
            available: false,
        },
        AgentTarget {
        ...
        AgentTarget {
            id: "wsl-antigravity-skills".into(),
            name: "WSL Antigravity Skills".into(),
            content_type: "skills".into(),
        ...
        AgentTarget {
            id: "wsl-antigravity-ide-skills".into(),
            name: "WSL Antigravity IDE Skills".into(),
            content_type: "skills".into(),
            path: "~/.gemini/antigravity-ide/skills".into(),
            backend: "wsl".into(),
            available: false,
        },
        AgentTarget {
